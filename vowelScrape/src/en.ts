...
class Controller {
    async exec(scraper : IScraper, analyzer : IAnalyzer) {
        ...
        const analyzed : AnalyzedData = await analyzer.analyze(scraped, analyzed_filename, (document : Document, analyzed_data : AnalyzedData) : AnalyzedData => {
            ...
            // this is example for japanese character convert vowel table

            // pickup element list of each characters
            ...
            // listed only need text from element list
            ...
            // split hiragana katakana are mixed
            ...
            // combine created list from hiragana only and katakana only
            ...
            // create vowel list from hiragana katakana list and romaji list
